...
###############################################################################
# Autonomous Circular Flight Demonstration Script
# 
# This script helps you run the autonomous circular trajectory flight demo
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  Autonomous Circular Flight Demo${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo ""
print_success "Great! Starting the circular flight demo..."
echo ""
...
echo "  - Circle Radius: 4.0 meters"
echo "  - Flight Height: 5.0 meters"
echo "  - Angular Velocity: 0.3 rad/s"
echo "  - Number of Circles: 2"
echo "  - Trail Length: 10 positions"
echo ""

# Launch the system
print_info "Launching circular trajectory flight with RViz..."
echo ""
